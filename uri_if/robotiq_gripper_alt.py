"""
Alternative control of robotiq gripper
"""
import rtde_control
...
class RobotiqGripperAlt(object):
    """ 
    RobotiqGripperAlt is a class for controlling a robotiq gripper using the
    ...
    def __init__(self, rtde_c): 
        """ 
        The constructor for RobotiqGripperAlt class. 
    ...
    """
    Since we only have write permissions anyway, these don't mean anything
    """
